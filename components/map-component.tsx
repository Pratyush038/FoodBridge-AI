...
// Dynamically import Leaflet map for when Google Maps is unavailable
      ...
      <Card className="w-full">
        ...
        <CardContent>
          {mapsUnavailable || loadError ? (
            // Fallback: Use Leaflet/OpenStreetMap (free, no API key needed)
            <div className="w-full -mt-4 -mx-6">
              <LeafletMapComponent
                markers={markers}
                center={center}
                onMarkerClick={onMarkerClick}
                showFilters={false} // Filters already shown in parent
              />
            </div>
          ) : !googleMapsLoaded ? (
